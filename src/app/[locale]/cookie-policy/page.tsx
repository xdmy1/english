...
export async function generateMetadata(props: Props): Promise<Metadata> {
  ...
  return pageMetadata({
    locale,
    route: "cookies",
    title: dict.legal.cookies.seo.title,
    description: dict.legal.cookies.seo.description,
  });
}

export default async function CookiePolicyPage(props: Props) {
  const { locale } = await props.params;
